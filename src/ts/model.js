...
export const TARGET = new THREE.Vector3(-1, 0, 0)
...
controls.minPolarAngle = 0 // Не опускаться слишком низко
controls.maxPolarAngle = Math.PI / 2 // Не переворачивать вверх
...
factoryShadow(scene, 0xffffff, 1000, 2, 2, new THREE.Vector3(15, 3, 15), false)
