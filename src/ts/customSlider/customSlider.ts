...
import { TEventName, TInitOptions, TSlider, TSliderEvents, TSliderInit } from './types'
...
export const slider: TSliderInit = (target, options = {}, plugins = []) => {
	...
	const slides = [...track.querySelectorAll(':scope >  .slide')] as HTMLElement[]
