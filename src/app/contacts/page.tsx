			...
			<section className='pt-header pb-md min-h-screen flex flex-col'>
				<div className='wrapper py-md md:py-lg flex flex-col flex-1'>
					<div className='flex gap-md md:gap-lg flex-1 flex-wrap'>
							...
							<div className='flex flex-wrap gap-md md:gap-xl'>
								...
								<div className='flex flex-col flex-1'>
									<div data-ai='4' className='flex items-center gap-sm'>
										...
										<a className='btn link' href='mailto:pbk59@yandex.ru' area-label='Почта компании'>
											<span></span>
											<span></span>
											<span></span>
											<span></span>
									...
									<div data-ai='4' className='flex items-center gap-sm'>
										...
										<a className='btn link' href='tel:+7(342)259-24-46' area-label='Почта компании'>
											<span></span>
											<span></span>
											<span></span>
											<span></span>
						...
						<div className='flex max-md:flex-col gap-xl *:flex-1'>
							<RequestForm isIntro />

							<div data-ai='4' className='h-full'>
								<CustomImage className='h-full object-cover saturate-0' src='/pictures/map.png' alt='' />
							</div>
						</div>
					</div>
				</div>
