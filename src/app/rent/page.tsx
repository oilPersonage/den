  ...
  return (
    <>
      <div className="min-h-screen main-wrapper mt-header">
        <Navs page="/rent" />
        <div className="py-lg">
          <div className="flex max-md:flex-col gap-md md:gap-xl justify-between">
            <div className="flex flex-col gap-xs">
              <p>Бытовки под ключ от 24 часа — без предоплаты!</p>
              <h1>Аренда бытовок в Перми</h1>
            </div>

            <p className="max-w-200 md:text-right">
              Нужна бытовка на стройку, офис или склад завтра утром? Сдаем
              профессиональные модульные конструкции с утеплением, электрикой и
              мебелью. Доставка по Перми и краю в день заказа.
            </p>
          </div>
