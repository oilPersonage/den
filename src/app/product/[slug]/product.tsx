...
export default function ProductSection({ product, sameProducts }: { product: Product; sameProducts: Product[] }) {
	...
	return (
		<div className='main-wrapper pt-header'>
			<h1 className='md:text-center mx-auto py-md md:pb-lg max-w-200 text-2xl md:text-3xl' data-ai='2'>
				{h1}
			</h1>
			<div className='flex gap-md md:gap-xl md:pb-lg *:flex-1 max-xl:flex-col' data-product-clider-wrapper>
				<div className='flex flex-col gap-sm md:gap-md'>
					...
					<div>
						<ShowMoreText dataAttr={{ 'data-ai': '3' }} slug={product.slug} description={headingDescription} />
					</div>
				</div>
				<ProductInfo
