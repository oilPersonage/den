	...
	return (
		<>
			<div className='flex flex-col flex-1'>
				...
				<ul className='flex gap-1 flex-wrap md:mb-md mb-md product-variant-btns'>
					{sameProducts.map((el) => (
						<SameProductBtn key={el.id} isActive={el.slug === slug} product={el} setActiveProduct={setActiveProduct} />
					))}
				</ul>
