...
export default function SameProductBtn({ product, isActive }: { product: Product; isActive: boolean }) {
	return (
		<div className='slide'>
			<button data-dot className={`group btn link  same-product-btn ${isActive ? 'active' : ''}`}>
				<div
