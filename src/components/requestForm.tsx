export default function RequestForm() {
	return (
		<div className='flex-1 max-md:order-2'>
			<h4 data-ai='3' className='mb-sm max-md:mb-md max-md:hidden' data-from-bottom>
				Напишите нам
			</h4>
			<form action='#' className='flex flex-col gap-sm'>
				<div className='flex flex-col gap-md mb-sm'>
					<label htmlFor='name' data-ai='4' data-from-bottom>
						...
						<div className='input-wrapper'>
							<input className='input-base' type='text' name='name' placeholder='Имя' />
							<span></span>
							<span></span>
							<span></span>
							<span></span>
					...
					<label htmlFor='phone' data-ai='4' data-from-bottom>
						<p>Ваш телефон</p>
						<div className='input-wrapper'>
							<input className='input-base' type='text' placeholder='Телефон' name='phone' data-phone />
				...
				<label data-ai='4' htmlFor='description' className='mb-md' data-from-bottom>
					<p>Описание</p>
					<div className='input-wrapper'>
						<textarea className='input-base' placeholder='Напишите ваш вопрос' name='description'></textarea>
