var B_=Object.defineProperty;var Ee=(i,e)=>()=>(i&&(e=i(i=0)),e);var Ya=(i,e)=>{for(var t in e)B_(i,t,{get:e[t],enumerable:!0})};var Ps,Kf,zi,_r=Ee(()=>{"use strict";Ps=!!document.querySelector("[data-page-index]"),Kf=!!document.querySelector("[data-page-questions]"),zi=window.matchMedia("(max-width: 480px)").matches});var tn,ii,ct,vt,Ze,Wt,Dt,Vh,xi,$a,yi,Jf,Ge,_o,Bn,xo,nn,jf,xr,Ls,yr,je,Qf,ep,tp,np,ip,sp,Hh,Za,rp,op,Ka,ap,Rt=Ee(()=>{tn=typeof window<"u",ii=tn?window:null,ct=tn?document:null,vt={OBJECT:0,ATTRIBUTE:1,CSS:2,TRANSFORM:3,CSS_VAR:4},Ze={NUMBER:0,UNIT:1,COLOR:2,COMPLEX:3},Wt={NONE:0,AUTO:1,FORCE:2},Dt={replace:0,none:1,blend:2},Vh=Symbol(),xi=Symbol(),$a=Symbol(),yi=Symbol(),Jf=Symbol(),Ge=1e-11,_o=1e12,Bn=1e3,xo=240,nn="",jf="var(",xr=(()=>{let i=new Map;return i.set("x","translateX"),i.set("y","translateY"),i.set("z","translateZ"),i})(),Ls=["translateX","translateY","translateZ","rotate","rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","skew","skewX","skewY","matrix","matrix3d","perspective"],yr=Ls.reduce((i,e)=>({...i,[e]:e+"("}),{}),je=()=>{},Qf=/\)\s*[-.\d]/,ep=/(^#([\da-f]{3}){1,2}$)|(^#([\da-f]{4}){1,2}$)/i,tp=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i,np=/rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(-?\d+|-?\d*.\d+)\s*\)/i,ip=/hsl\(\s*(-?\d+|-?\d*.\d+)\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)%\s*\)/i,sp=/hsla\(\s*(-?\d+|-?\d*.\d+)\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)\s*\)/i,Hh=/[-+]?\d*\.?\d+(?:e[-+]?\d)?/gi,Za=/^([-+]?\d*\.?\d+(?:e[-+]?\d+)?)([a-z]+|%)$/i,rp=/([a-z])([A-Z])/g,op=/(\w+)(\([^)]+\)+)/g,Ka=/(\*=|\+=|-=)/,ap=/var\(\s*(--[\w-]+)(?:\s*,\s*([^)]+))?\s*\)/});var vr,En,Xe,yo,Gh,wn=Ee(()=>{Rt();vr={id:null,keyframes:null,playbackEase:null,playbackRate:1,frameRate:xo,loop:0,reversed:!1,alternate:!1,autoplay:!0,persist:!1,duration:Bn,delay:0,loopDelay:0,ease:"out(2)",composition:Dt.replace,modifier:i=>i,onBegin:je,onBeforeUpdate:je,onUpdate:je,onLoop:je,onPause:je,onComplete:je,onRender:je},En={current:null,root:ct},Xe={defaults:vr,precision:4,timeScale:1,tickThreshold:200},yo=tn&&ii.AnimeJSDevTools,Gh={version:"4.3.6",engine:null};tn&&(ii.AnimeJS||(ii.AnimeJS=[]),ii.AnimeJS.push(Gh))});var Sr,Ct,Vi,ln,cn,zt,It,Tt,fe,$n,Ja,Xh,qh,Yh,cp,Ns,k_,hp,ja,Us,Qa,up,dp,Ds,vo,fp,pp,So,Wh,Ot,lp,Qe,mp,An,Fs,Hi,Vt,el,rt,kn,gn,Pt=Ee(()=>{Rt();wn();Sr=i=>i.replace(rp,"$1-$2").toLowerCase(),Ct=(i,e)=>i.indexOf(e)===0,Vi=Date.now,ln=Array.isArray,cn=i=>i&&i.constructor===Object,zt=i=>typeof i=="number"&&!isNaN(i),It=i=>typeof i=="string",Tt=i=>typeof i=="function",fe=i=>typeof i>"u",$n=i=>fe(i)||i===null,Ja=i=>tn&&i instanceof SVGElement,Xh=i=>ep.test(i),qh=i=>Ct(i,"rgb"),Yh=i=>Ct(i,"hsl"),cp=i=>Xh(i)||(qh(i)||Yh(i))&&(i[i.length-1]===")"||!Qf.test(i)),Ns=i=>!Xe.defaults.hasOwnProperty(i),k_=["opacity","rotate","overflow","color"],hp=(i,e)=>{if(k_.includes(e))return!1;if(i.getAttribute(e)||e in i){if(e==="scale"){let t=i.parentNode;return t&&t.tagName==="filter"}return!0}},ja=i=>It(i)?parseFloat(i):i,Us=Math.pow,Qa=Math.sqrt,up=Math.sin,dp=Math.cos,Ds=Math.abs,vo=Math.floor,fp=Math.asin,pp=Math.max,So=Math.PI,Wh=Math.round,Ot=(i,e,t)=>i<e?e:i>t?t:i,lp={},Qe=(i,e)=>{if(e<0)return i;if(!e)return Wh(i);let t=lp[e];return t||(t=lp[e]=10**e),Wh(i*t)/t},mp=(i,e)=>ln(e)?e.reduce((t,n)=>Ds(n-i)<Ds(t-i)?n:t):e?Wh(i/e)*e:i,An=(i,e,t)=>i+(e-i)*t,Fs=i=>i===1/0?_o:i===-1/0?-_o:i,Hi=i=>i<=Ge?Ge:Fs(Qe(i,11)),Vt=i=>ln(i)?[...i]:i,el=(i,e)=>{let t={...i};for(let n in e){let s=i[n];t[n]=fe(s)?e[n]:s}return t},rt=(i,e,t,n="_prev",s="_next")=>{let r=i._head,o=s;for(t&&(r=i._tail,o=n);r;){let a=r[o];e(r),r=a}},kn=(i,e,t="_prev",n="_next")=>{let s=e[t],r=e[n];s?s[n]=r:i._head=r,r?r[t]=s:i._tail=s,e[t]=null,e[n]=null},gn=(i,e,t,n="_prev",s="_next")=>{let r=i._tail;for(;r&&t&&t(r,e);)r=r[n];let o=r?r[s]:i._head;r?r[s]=e:i._head=e,o?o[n]=e:i._tail=e,e[n]=r,e[s]=o}});var gp,_p=Ee(()=>{Rt();Pt();gp=(i,e,t)=>{let n=i.style.transform,s;if(n){let r=i[yi],o;for(;o=op.exec(n);){let a=o[1],l=o[2].slice(1,-1);r[a]=l,a===e&&(s=l,t&&(t[e]=l))}}return n&&!fe(s)?s:Ct(e,"scale")?"1":Ct(e,"rotate")||Ct(e,"skew")?"0deg":"0px"}});var z_,V_,$h,H_,xp,yp=Ee(()=>{Rt();Pt();z_=i=>{let e=tp.exec(i)||np.exec(i),t=fe(e[4])?1:+e[4];return[+e[1],+e[2],+e[3],t]},V_=i=>{let e=i.length,t=e===4||e===5;return[+("0x"+i[1]+i[t?1:2]),+("0x"+i[t?2:3]+i[t?2:4]),+("0x"+i[t?3:5]+i[t?3:6]),e===5||e===9?+(+("0x"+i[t?4:7]+i[t?4:8])/255).toFixed(3):1]},$h=(i,e,t)=>(t<0&&(t+=1),t>1&&(t-=1),t<1/6?i+(e-i)*6*t:t<1/2?e:t<2/3?i+(e-i)*(2/3-t)*6:i),H_=i=>{let e=ip.exec(i)||sp.exec(i),t=+e[1]/360,n=+e[2]/100,s=+e[3]/100,r=fe(e[4])?1:+e[4],o,a,l;if(n===0)o=a=l=s;else{let c=s<.5?s*(1+n):s+n-s*n,h=2*s-c;o=Qe($h(h,c,t+1/3)*255,0),a=Qe($h(h,c,t)*255,0),l=Qe($h(h,c,t-1/3)*255,0)}return[o,a,l,r]},xp=i=>qh(i)?z_(i):Xh(i)?V_(i):Yh(i)?H_(i):[0,0,0,1]});var Ne,sn,Mo,vp,vi,Si,tl,hn,Zh,rn,Mi=Ee(()=>{Rt();Pt();_p();yp();Ne=(i,e)=>fe(i)?e:i,sn=(i,e,t,n,s)=>{let r;if(Tt(i))r=()=>{let o=i(e,t,n);return isNaN(+o)?o||0:+o};else if(It(i)&&Ct(i,jf))r=()=>{let o=i.match(ap),a=o[1],l=o[2],c=getComputedStyle(e)?.getPropertyValue(a);return(!c||c.trim()===nn)&&l&&(c=l.trim()),c||0};else return i;return s&&(s.func=r),r()},Mo=(i,e)=>i[xi]?i[$a]&&hp(i,e)?vt.ATTRIBUTE:Ls.includes(e)||xr.get(e)?vt.TRANSFORM:Ct(e,"--")?vt.CSS_VAR:e in i.style?vt.CSS:e in i?vt.OBJECT:vt.ATTRIBUTE:vt.OBJECT,vp=(i,e,t)=>{let n=i.style[e];n&&t&&(t[e]=n);let s=n||getComputedStyle(i[Jf]||i).getPropertyValue(e);return s==="auto"?"0":s},vi=(i,e,t,n)=>{let s=fe(t)?Mo(i,e):t;return s===vt.OBJECT?i[e]||0:s===vt.ATTRIBUTE?i.getAttribute(e):s===vt.TRANSFORM?gp(i,e,n):s===vt.CSS_VAR?vp(i,e,n).trimStart():vp(i,e,n)},Si=(i,e,t)=>t==="-"?i-e:t==="+"?i+e:i*e,tl=()=>({t:Ze.NUMBER,n:0,u:null,o:null,d:null,s:null}),hn=(i,e)=>{if(e.t=Ze.NUMBER,e.n=0,e.u=null,e.o=null,e.d=null,e.s=null,!i)return e;let t=+i;if(isNaN(t)){let n=i;n[1]==="="&&(e.o=n[0],n=n.slice(2));let s=n.includes(" ")?!1:Za.exec(n);if(s)return e.t=Ze.UNIT,e.n=+s[1],e.u=s[2],e;if(e.o)return e.n=+n,e;if(cp(n))return e.t=Ze.COLOR,e.d=xp(n),e;{let r=n.match(Hh);return e.t=Ze.COMPLEX,e.d=r?r.map(Number):[],e.s=n.split(Hh)||[],e}}else return e.n=t,e},Zh=(i,e)=>(e.t=i._valueType,e.n=i._toNumber,e.u=i._unit,e.o=null,e.d=Vt(i._toNumbers),e.s=Vt(i._strings),e),rn=tl()});var bo,bi,To=Ee(()=>{wn();Rt();Pt();bo=(i,e,t,n,s)=>{let r=i.parent,o=i.duration,a=i.completed,l=i.iterationDuration,c=i.iterationCount,h=i._currentIteration,u=i._loopDelay,d=i._reversed,p=i._alternate,g=i._hasChildren,_=i._delay,m=i._currentTime,f=_+l,v=e-_,T=Ot(m,-_,o),b=Ot(v,-_,o),E=v-m,A=b>0,R=b>=o,P=o<=Ge,y=s===Wt.FORCE,S=0,C=v,D=0;if(c>1){let H=~~(b/(l+(R?0:u)));i._currentIteration=Ot(H,0,c),R&&i._currentIteration--,S=i._currentIteration%2,C=b%(l+u)||0}let U=d^(p&&S),L=i._ease,z=R?U?0:o:U?l-C:C;L&&(z=l*L(z/l)||0);let O=(r?r.backwards:v<m)?!U:!!U;if(i._currentTime=v,i._iterationTime=z,i.backwards=O,A&&!i.began?(i.began=!0,!t&&!(r&&(O||!r.began))&&i.onBegin(i)):v<=0&&(i.began=!1),!t&&!g&&A&&i._currentIteration!==h&&i.onLoop(i),y||s===Wt.AUTO&&(e>=_&&e<=f||e<=_&&T>_||e>=f&&T!==o)||z>=f&&T!==o||z<=_&&T>0||e<=T&&T===o&&a||R&&!a&&P){if(A&&(i.computeDeltaTime(T),t||i.onBeforeUpdate(i)),!g){let H=y||(O?E*-1:E)>=Xe.tickThreshold,Y=i._offset+(r?r._offset:0)+_+z,G=i._head,K,se,xe,Se,Je=0;for(;G;){let $e=G._composition,$=G._currentTime,J=G._changeDuration,he=G._absoluteStartTime+G._changeDuration,De=G._nextRep,ge=G._prevRep,ze=$e!==Dt.none;if((H||($!==J||Y<=he+(De?De._delay:0))&&($!==0||Y>=G._absoluteStartTime))&&(!ze||!G._isOverridden&&(!G._isOverlapped||Y<=he)&&(!De||De._isOverridden||Y<=De._absoluteStartTime)&&(!ge||ge._isOverridden||Y>=ge._absoluteStartTime+ge._changeDuration+G._delay))){let xt=G._currentTime=Ot(z-G._startTime,0,J),Le=G._ease(xt/G._updateDuration),We=G._modifier,it=G._valueType,Re=G._tweenType,ht=Re===vt.OBJECT,I=it===Ze.NUMBER,pt=I&&ht||Le===0||Le===1?-1:Xe.precision,Ve,lt;if(I)Ve=lt=We(Qe(An(G._fromNumber,G._toNumber,Le),pt));else if(it===Ze.UNIT)lt=We(Qe(An(G._fromNumber,G._toNumber,Le),pt)),Ve=`${lt}${G._unit}`;else if(it===Ze.COLOR){let re=G._fromNumbers,w=G._toNumbers,x=Qe(Ot(We(An(re[0],w[0],Le)),0,255),0),F=Qe(Ot(We(An(re[1],w[1],Le)),0,255),0),Z=Qe(Ot(We(An(re[2],w[2],Le)),0,255),0),j=Ot(We(Qe(An(re[3],w[3],Le),pt)),0,1);if(Ve=`rgba(${x},${F},${Z},${j})`,ze){let q=G._numbers;q[0]=x,q[1]=F,q[2]=Z,q[3]=j}}else if(it===Ze.COMPLEX){Ve=G._strings[0];for(let re=0,w=G._toNumbers.length;re<w;re++){let x=We(Qe(An(G._fromNumbers[re],G._toNumbers[re],Le),pt)),F=G._strings[re+1];Ve+=`${F?x+F:x}`,ze&&(G._numbers[re]=x)}}if(ze&&(G._number=lt),!n&&$e!==Dt.blend){let re=G.property;K=G.target,ht?K[re]=Ve:Re===vt.ATTRIBUTE?K.setAttribute(re,Ve):(se=K.style,Re===vt.TRANSFORM?(K!==xe&&(xe=K,Se=K[yi]),Se[re]=Ve,Je=1):Re===vt.CSS?se[re]=Ve:Re===vt.CSS_VAR&&se.setProperty(re,Ve)),A&&(D=1)}else G._value=Ve}if(Je&&G._renderTransforms){let xt=nn;for(let Le in Se)xt+=`${yr[Le]}${Se[Le]}) `;se.transform=xt,Je=0}G=G._next}!t&&D&&i.onRender(i)}!t&&A&&i.onUpdate(i)}return r&&P?!t&&(r.began&&!O&&v>0&&!a||O&&v<=Ge&&a)&&(i.onComplete(i),i.completed=!O):A&&R?c===1/0?i._startTime+=i.duration:i._currentIteration>=c-1&&(i.paused=!0,!a&&!g&&(i.completed=!0,!t&&!(r&&(O||!r.began))&&(i.onComplete(i),i._resolve(i)))):i.completed=!1,D},bi=(i,e,t,n,s)=>{let r=i._currentIteration;if(bo(i,e,t,n,s),i._hasChildren){let o=i,a=o.backwards,l=n?e:o._iterationTime,c=Vi(),h=0,u=!0;if(!n&&o._currentIteration!==r){let d=o.iterationDuration;rt(o,p=>{if(!a)!p.completed&&!p.backwards&&p._currentTime<p.iterationDuration&&bo(p,d,t,1,Wt.FORCE),p.began=!1,p.completed=!1;else{let g=p.duration,_=p._offset+p._delay,m=_+g;!t&&g<=Ge&&(!_||m===d)&&p.onComplete(p)}}),t||o.onLoop(o)}rt(o,d=>{let p=Qe((l-d._offset)*d._speed,12),g=d._fps<o._fps?d.requestTick(c):s;h+=bo(d,p,t,n,g),!d.completed&&u&&(u=!1)},a),!t&&h&&o.onRender(o),(u||a)&&o._currentTime>=o.duration&&(o.paused=!0,o.completed||(o.completed=!0,t||(o.onComplete(o),o._resolve(o))))}}});var Sp,Mr,Os,br=Ee(()=>{Rt();Pt();Sp={},Mr=(i,e,t)=>{if(t===vt.TRANSFORM){let n=xr.get(i);return n||i}else if(t===vt.CSS||t===vt.ATTRIBUTE&&Ja(e)&&i in e.style){let n=Sp[i];if(n)return n;{let s=i&&Sr(i);return Sp[i]=s,s}}else return i},Os=i=>{if(i._hasChildren)rt(i,Os,!0);else{let e=i;e.pause(),rt(e,t=>{let n=t.property,s=t.target;if(s[xi]){let r=s.style,o=t._inlineValue,a=$n(o)||o===nn;if(t._tweenType===vt.TRANSFORM){let l=s[yi];if(a?delete l[n]:l[n]=o,t._renderTransforms)if(!Object.keys(l).length)r.removeProperty("transform");else{let c=nn;for(let h in l)c+=yr[h]+l[h]+") ";r.transform=c}}else a?r.removeProperty(Sr(n)):r[n]=o;e._tail===t&&e.targets.forEach(l=>{l.getAttribute&&l.getAttribute("style")===nn&&l.removeAttribute("style")})}})}return i}});var Tr,Kh=Ee(()=>{Rt();wn();Tr=class{constructor(e=0){this.deltaTime=0,this._currentTime=e,this._lastTickTime=e,this._startTime=e,this._lastTime=e,this._scheduledTime=0,this._frameDuration=Bn/xo,this._fps=xo,this._speed=1,this._hasChildren=!1,this._head=null,this._tail=null}get fps(){return this._fps}set fps(e){let t=this._frameDuration,n=+e,s=n<Ge?Ge:n,r=Bn/s;s>vr.frameRate&&(vr.frameRate=s),this._fps=s,this._frameDuration=r,this._scheduledTime+=r-t}get speed(){return this._speed}set speed(e){let t=+e;this._speed=t<Ge?Ge:t}requestTick(e){let t=this._scheduledTime;if(this._lastTickTime=e,e<t)return Wt.NONE;let n=this._frameDuration,s=e-t;return this._scheduledTime+=s<n?n:s,Wt.AUTO}computeDeltaTime(e){let t=e-this._lastTime;return this.deltaTime=t,this._lastTime=e,t}}});var Gi,Mp,nl=Ee(()=>{Rt();Pt();To();Gi={animation:null,update:je},Mp=i=>{let e=Gi.animation;return e||(e={duration:Ge,computeDeltaTime:je,_offset:0,_delay:0,_head:null,_tail:null},Gi.animation=e,Gi.update=()=>{i.forEach(t=>{for(let n in t){let s=t[n],r=s._head;if(r){let o=r._valueType,a=o===Ze.COMPLEX||o===Ze.COLOR?Vt(r._fromNumbers):null,l=r._fromNumber,c=s._tail;for(;c&&c!==r;){if(a)for(let h=0,u=c._numbers.length;h<u;h++)a[h]+=c._numbers[h];else l+=c._number;c=c._prevAdd}r._toNumber=l,r._toNumbers=a}}}),bo(e,1,1,0,Wt.FORCE)}),e}});var bp,G_,Jh,Xt,Tp,W_,jh=Ee(()=>{wn();Rt();Pt();Kh();To();nl();bp=tn?requestAnimationFrame:setImmediate,G_=tn?cancelAnimationFrame:clearImmediate,Jh=class extends Tr{constructor(e){super(e),this.useDefaultMainLoop=!0,this.pauseOnDocumentHidden=!0,this.defaults=vr,this.paused=!0,this.reqId=0}update(){let e=this._currentTime=Vi();if(this.requestTick(e)){this.computeDeltaTime(e);let t=this._speed,n=this._fps,s=this._head;for(;s;){let r=s._next;s.paused?(kn(this,s),this._hasChildren=!!this._tail,s._running=!1,s.completed&&!s._cancelled&&s.cancel()):bi(s,(e-s._startTime)*s._speed*t,0,0,s._fps<n?s.requestTick(e):Wt.AUTO),s=r}Gi.update()}}wake(){return this.useDefaultMainLoop&&!this.reqId&&(this.requestTick(Vi()),this.reqId=bp(Tp)),this}pause(){if(this.reqId)return this.paused=!0,W_()}resume(){if(this.paused)return this.paused=!1,rt(this,e=>e.resetTime()),this.wake()}get speed(){return this._speed*(Xe.timeScale===1?1:Bn)}set speed(e){this._speed=e*Xe.timeScale,rt(this,t=>t.speed=t._speed)}get timeUnit(){return Xe.timeScale===1?"ms":"s"}set timeUnit(e){let n=e==="s",s=n?.001:1;if(Xe.timeScale!==s){Xe.timeScale=s,Xe.tickThreshold=200*s;let r=n?.001:Bn;this.defaults.duration*=r,this._speed*=r}}get precision(){return Xe.precision}set precision(e){Xe.precision=e}},Xt=(()=>{let i=new Jh(Vi());return tn&&(Gh.engine=i,ct.addEventListener("visibilitychange",()=>{i.pauseOnDocumentHidden&&(ct.hidden?i.pause():i.resume())})),i})(),Tp=()=>{Xt._head?(Xt.reqId=bp(Tp),Xt.update()):Xt.reqId=0},W_=()=>(G_(Xt.reqId),Xt.reqId=0,Xt)});var il,wo,X_,Eo,sl,Qh,Ep,Ao,Ro=Ee(()=>{Rt();Pt();br();jh();nl();il={_rep:new WeakMap,_add:new Map},wo=(i,e,t="_rep")=>{let n=il[t],s=n.get(i);return s||(s={},n.set(i,s)),s[e]?s[e]:s[e]={_head:null,_tail:null}},X_=(i,e)=>i._isOverridden||i._absoluteStartTime>e._absoluteStartTime,Eo=i=>{i._isOverlapped=1,i._isOverridden=1,i._changeDuration=Ge,i._currentTime=Ge},sl=(i,e)=>{let t=i._composition;if(t===Dt.replace){let n=i._absoluteStartTime;gn(e,i,X_,"_prevRep","_nextRep");let s=i._prevRep;if(s){let r=s.parent,o=s._absoluteStartTime+s._changeDuration;if(i.parent.id!==r.id&&r.iterationCount>1&&o+(r.duration-r.iterationDuration)>n){Eo(s);let c=s._prevRep;for(;c&&c.parent.id===r.id;)Eo(c),c=c._prevRep}let a=n-i._delay;if(o>a){let c=s._startTime,h=o-(c+s._updateDuration),u=Qe(a-h-c,12);s._changeDuration=u,s._currentTime=u,s._isOverlapped=1,u<Ge&&Eo(s)}let l=!0;if(rt(r,c=>{c._isOverlapped||(l=!1)}),l){let c=r.parent;if(c){let h=!0;rt(c,u=>{u!==r&&rt(u,d=>{d._isOverlapped||(h=!1)})}),h&&c.cancel()}else r.cancel()}}}else if(t===Dt.blend){let n=wo(i.target,i.property,"_add"),s=Mp(il._add),r=n._head;r||(r={...i},r._composition=Dt.replace,r._updateDuration=Ge,r._startTime=0,r._numbers=Vt(i._fromNumbers),r._number=0,r._next=null,r._prev=null,gn(n,r),gn(s,r));let o=i._toNumber;if(i._fromNumber=r._fromNumber-o,i._toNumber=0,i._numbers=Vt(i._fromNumbers),i._number=0,r._fromNumber=o,i._toNumbers){let a=Vt(i._toNumbers);a&&a.forEach((l,c)=>{i._fromNumbers[c]=r._fromNumbers[c]-l,i._toNumbers[c]=0}),r._fromNumbers=a}gn(n,i,null,"_prevAdd","_nextAdd")}return i},Qh=i=>{let e=i._composition;if(e!==Dt.none){let t=i.target,n=i.property,o=il._rep.get(t)[n];if(kn(o,i,"_prevRep","_nextRep"),e===Dt.blend){let a=il._add,l=a.get(t);if(!l)return;let c=l[n],h=Gi.animation;kn(c,i,"_prevAdd","_nextAdd");let u=c._head;if(u&&u===c._tail){kn(c,u,"_prevAdd","_nextAdd"),kn(h,u);let d=!0;for(let p in l)if(l[p]._head){d=!1;break}d&&a.delete(t)}}}return i},Ep=(i,e,t)=>{let n=!1;return rt(e,s=>{let r=s.target;if(i.includes(r)){let o=s.property,a=s._tweenType,l=Mr(t,r,a);(!l||l&&l===o)&&(s.parent._tail===s&&s._tweenType===vt.TRANSFORM&&s._prev&&s._prev._tweenType===vt.TRANSFORM&&(s._prev._renderTransforms=1),kn(e,s),Qh(s),n=!0)}},!0),n},Ao=(i,e,t)=>{let n=e||Xt,s;if(n._hasChildren){let r=0;rt(n,o=>{if(!o._hasChildren)if(s=Ep(i,o,t),s&&!o._head)o.cancel(),kn(n,o);else{let l=o._offset+o._delay+o.duration;l>r&&(r=l)}o._head?Ao(i,o,t):o._hasChildren=!1},!0),fe(n.iterationDuration)||(n.iterationDuration=r)}else s=Ep(i,n,t);s&&!n._head&&(n._hasChildren=!1,n.cancel&&n.cancel())}});var wp,eu,Ap,Rn,Co=Ee(()=>{Rt();Pt();wn();Mi();To();Ro();Kh();jh();wp=i=>(i.paused=!0,i.began=!1,i.completed=!1,i),eu=i=>(i._cancelled&&(i._hasChildren?rt(i,eu):rt(i,e=>{e._composition!==Dt.none&&sl(e,wo(e.target,e.property))}),i._cancelled=0),i),Ap=0,Rn=class extends Tr{constructor(e={},t=null,n=0){super(0),++Ap;let{id:s,delay:r,duration:o,reversed:a,alternate:l,loop:c,loopDelay:h,autoplay:u,frameRate:d,playbackRate:p,onComplete:g,onLoop:_,onPause:m,onBegin:f,onBeforeUpdate:v,onUpdate:T}=e;En.current&&En.current.register(this);let b=t?0:Xt._lastTickTime,E=t?t.defaults:Xe.defaults,A=Tt(r)||fe(r)?E.delay:+r,R=Tt(o)||fe(o)?1/0:+o,P=Ne(c,E.loop),y=Ne(h,E.loopDelay),S=P===!0||P===1/0||P<0?1/0:P+1;if(yo){let D=S===1/0;if(yo.register(this,e,D)&&D){let L=l?2:1,z=t?yo.maxNestedInfiniteLoops:yo.maxInfiniteLoops;S=Math.max(z,L)}}let C=0;t?C=n:(Xt.reqId||Xt.requestTick(Vi()),C=(Xt._lastTickTime-Xt._startTime)*Xe.timeScale),this.id=fe(s)?Ap:s,this.parent=t,this.duration=Fs((R+y)*S-y)||Ge,this.backwards=!1,this.paused=!0,this.began=!1,this.completed=!1,this.onBegin=f||E.onBegin,this.onBeforeUpdate=v||E.onBeforeUpdate,this.onUpdate=T||E.onUpdate,this.onLoop=_||E.onLoop,this.onPause=m||E.onPause,this.onComplete=g||E.onComplete,this.iterationDuration=R,this.iterationCount=S,this._autoplay=t?!1:Ne(u,E.autoplay),this._offset=C,this._delay=A,this._loopDelay=y,this._iterationTime=0,this._currentIteration=0,this._resolve=je,this._running=!1,this._reversed=+Ne(a,E.reversed),this._reverse=this._reversed,this._cancelled=0,this._alternate=Ne(l,E.alternate),this._prev=null,this._next=null,this._lastTickTime=b,this._startTime=b,this._lastTime=b,this._fps=Ne(d,E.frameRate),this._speed=Ne(p,E.playbackRate)}get cancelled(){return!!this._cancelled}set cancelled(e){e?this.cancel():this.reset(!0).play()}get currentTime(){return Ot(Qe(this._currentTime,Xe.precision),-this._delay,this.duration)}set currentTime(e){let t=this.paused;this.pause().seek(+e),t||this.resume()}get iterationCurrentTime(){return Ot(Qe(this._iterationTime,Xe.precision),0,this.iterationDuration)}set iterationCurrentTime(e){this.currentTime=this.iterationDuration*this._currentIteration+e}get progress(){return Ot(Qe(this._currentTime/this.duration,10),0,1)}set progress(e){this.currentTime=this.duration*e}get iterationProgress(){return Ot(Qe(this._iterationTime/this.iterationDuration,10),0,1)}set iterationProgress(e){let t=this.iterationDuration;this.currentTime=t*this._currentIteration+t*e}get currentIteration(){return this._currentIteration}set currentIteration(e){this.currentTime=this.iterationDuration*Ot(+e,0,this.iterationCount-1)}get reversed(){return!!this._reversed}set reversed(e){e?this.reverse():this.play()}get speed(){return super.speed}set speed(e){super.speed=e,this.resetTime()}reset(e=!1){return eu(this),this._reversed&&!this._reverse&&(this.reversed=!1),this._iterationTime=this.iterationDuration,bi(this,0,1,~~e,Wt.FORCE),wp(this),this._hasChildren&&rt(this,wp),this}init(e=!1){this.fps=this._fps,this.speed=this._speed,!e&&this._hasChildren&&bi(this,this.duration,1,~~e,Wt.FORCE),this.reset(e);let t=this._autoplay;return t===!0?this.resume():t&&!fe(t.linked)&&t.link(this),this}resetTime(){let e=1/(this._speed*Xt._speed);return this._startTime=Vi()-(this._currentTime+this._delay)*e,this}pause(){return this.paused?this:(this.paused=!0,this.onPause(this),this)}resume(){return this.paused?(this.paused=!1,this.duration<=Ge&&!this._hasChildren?bi(this,Ge,0,0,Wt.FORCE):(this._running||(gn(Xt,this),Xt._hasChildren=!0,this._running=!0),this.resetTime(),this._startTime-=12,Xt.wake()),this):this}restart(){return this.reset().resume()}seek(e,t=0,n=0){eu(this),this.completed=!1;let s=this.paused;return this.paused=!0,bi(this,e+this._delay,~~t,~~n,Wt.AUTO),s?this:this.resume()}alternate(){let e=this._reversed,t=this.iterationCount,n=this.iterationDuration,s=t===1/0?vo(_o/n):t;return this._reversed=+(this._alternate&&!(s%2)?e:!e),t===1/0?this.iterationProgress=this._reversed?1-this.iterationProgress:this.iterationProgress:this.seek(n*s-this._currentTime),this.resetTime(),this}play(){return this._reversed&&this.alternate(),this.resume()}reverse(){return this._reversed||this.alternate(),this.resume()}cancel(){return this._hasChildren?rt(this,e=>e.cancel(),!0):rt(this,Qh),this._cancelled=1,this.pause()}stretch(e){let t=this.duration,n=Hi(e);if(t===n)return this;let s=e/t,r=e<=Ge;return this.duration=r?Ge:n,this.iterationDuration=r?Ge:Hi(this.iterationDuration*s),this._offset*=s,this._delay*=s,this._loopDelay*=s,this}revert(){bi(this,0,1,0,Wt.AUTO);let e=this._autoplay;return e&&e.linked&&e.linked===this&&e.revert(),this.cancel()}complete(e=0){return this.seek(this.duration,e).cancel()}then(e=je){let t=this.then,n=()=>{this.then=null,e(this),this.then=t,this._resolve=je};return new Promise(s=>(this._resolve=()=>s(n()),this.completed&&this._resolve(),this))}}});function rl(i){let e=It(i)?En.root.querySelectorAll(i):i;if(e instanceof NodeList||e instanceof HTMLCollection)return e}function Wi(i){if($n(i))return[];if(!tn)return ln(i)&&i.flat(1/0)||[i];if(ln(i)){let t=i.flat(1/0),n=[];for(let s=0,r=t.length;s<r;s++){let o=t[s];if(!$n(o)){let a=rl(o);if(a)for(let l=0,c=a.length;l<c;l++){let h=a[l];if(!$n(h)){let u=!1;for(let d=0,p=n.length;d<p;d++)if(n[d]===h){u=!0;break}u||n.push(h)}}else{let l=!1;for(let c=0,h=n.length;c<h;c++)if(n[c]===o){l=!0;break}l||n.push(o)}}}return n}let e=rl(i);return e?Array.from(e):[i]}function Ti(i){let e=Wi(i),t=e.length;if(t)for(let n=0;n<t;n++){let s=e[n];if(!s[Vh]){s[Vh]=!0;let r=Ja(s);(s.nodeType||r)&&(s[xi]=!0,s[$a]=r,s[yi]={})}}return e}var Xi=Ee(()=>{wn();Rt();Pt();});var tu,Rp,Bs,ol=Ee(()=>{Rt();Pt();tu={deg:1,rad:180/So,turn:360},Rp={},Bs=(i,e,t,n=!1)=>{let s=e.u,r=e.n;if(e.t===Ze.UNIT&&s===t)return e;let o=r+s+t,a=Rp[o];if(!fe(a)&&!n)e.n=a;else{let l;if(s in tu)l=r*tu[s]/tu[t];else{let h=i.cloneNode(),u=i.parentNode,d=u&&u!==ct?u:ct.body;d.appendChild(h);let p=h.style;p.width=100+s;let g=h.offsetWidth||100;p.width=100+t;let _=h.offsetWidth||100,m=g/_;d.removeChild(h),l=m*r}e.n=l,Rp[o]=l}return e.t,Ze.UNIT,e.u=t,e}});var un,Io=Ee(()=>{un=i=>i});var Po,iu,q_,Cp,Ip,nu,al,su,Pp,qi,Er=Ee(()=>{Rt();Pt();Io();Po=(i=1.68)=>e=>Us(e,+i),iu={in:i=>e=>i(e),out:i=>e=>1-i(1-e),inOut:i=>e=>e<.5?i(e*2)/2:1-i(e*-2+2)/2,outIn:i=>e=>e<.5?(1-i(1-e*2))/2:(i(e*2-1)+1)/2},q_=So/2,Cp=So*2,Ip={[nn]:Po,Quad:Po(2),Cubic:Po(3),Quart:Po(4),Quint:Po(5),Sine:i=>1-dp(i*q_),Circ:i=>1-Qa(1-i*i),Expo:i=>i?Us(2,10*i-10):0,Bounce:i=>{let e,t=4;for(;i<((e=Us(2,--t))-1)/11;);return 1/Us(4,3-t)-7.5625*Us((e*3-2)/22-i,2)},Back:(i=1.7)=>e=>(+i+1)*e*e*e-+i*e*e,Elastic:(i=1,e=.3)=>{let t=Ot(+i,1,10),n=Ot(+e,Ge,2),s=n/Cp*fp(1/t),r=Cp/n;return o=>o===0||o===1?o:-t*Us(2,-10*(1-o))*up((1-o-s)*r)}},nu=(()=>{let i={linear:un,none:un};for(let e in iu)for(let t in Ip){let n=Ip[t],s=iu[e];i[e+t]=t===nn||t==="Back"||t==="Elastic"?(r,o)=>s(n(r,o)):s(n)}return i})(),al={linear:un,none:un},su=i=>{if(al[i])return al[i];if(i.indexOf("(")<=-1){let t=iu[i]||i.includes("Back")||i.includes("Elastic")?nu[i]():nu[i];return t?al[i]=t:un}else{let e=i.slice(0,-1).split("("),t=nu[e[0]];return t?al[i]=t(...e[1].split(",")):un}},Pp=["steps(","irregular(","linear(","cubicBezier("],qi=i=>{if(It(i)){for(let t=0,n=Pp.length;t<n;t++)if(Ct(i,Pp[t]))return console.warn(`String syntax for \`ease: "${i}"\` has been removed from the core and replaced by importing and passing the easing function directly: \`ease: ${i}\``),un}return Tt(i)?i:It(i)?su(i):un}});var Oe,et,wr,ll,ru,cl,Ar,hl,Y_,Lp,ls,Ei,$_,cs,qt,ul=Ee(()=>{Rt();Pt();wn();Xi();Mi();br();ol();Er();Co();Ro();nl();Oe=tl(),et=tl(),wr={},ll={func:null},ru={func:null},cl=[null],Ar=[null,null],hl={to:null},Y_=0,Lp=0,$_=(i,e)=>{let t={};if(ln(i)){let n=[].concat(...i.map(s=>Object.keys(s))).filter(Ns);for(let s=0,r=n.length;s<r;s++){let o=n[s],a=i.map(l=>{let c={};for(let h in l){let u=l[h];Ns(h)?h===o&&(c.to=u):c[h]=u}return c});t[o]=a}}else{let n=Ne(e.duration,Xe.defaults.duration);Object.keys(i).map(r=>({o:parseFloat(r)/100,p:i[r]})).sort((r,o)=>r.o-o.o).forEach(r=>{let o=r.o,a=r.p;for(let l in a)if(Ns(l)){let c=t[l];c||(c=t[l]=[]);let h=o*n,u=c.length,d=c[u-1],p={to:a[l]},g=0;for(let _=0;_<u;_++)g+=c[_].duration;u===1&&(p.from=d.to),a.ease&&(p.ease=a.ease),p.duration=h-(u?g:0),c.push(p)}return r});for(let r in t){let o=t[r],a;for(let l=0,c=o.length;l<c;l++){let h=o[l],u=h.ease;h.ease=a||void 0,a=u}o[0].duration||o.shift()}}return t},cs=class extends Rn{constructor(e,t,n,s,r=!1,o=0,a=0){super(t,n,s),++Lp;let l=Ti(e),c=l.length,h=t.keyframes,u=h?el($_(h,t),t):t,{id:d,delay:p,duration:g,ease:_,playbackEase:m,modifier:f,composition:v,onRender:T}=u,b=n?n.defaults:Xe.defaults,E=Ne(_,b.ease),A=Ne(m,b.playbackEase),R=A?qi(A):null,P=!fe(E.ease),y=P?E.ease:Ne(_,R?"linear":b.ease),S=P?E.settlingDuration:Ne(g,b.duration),C=Ne(p,b.delay),D=f||b.modifier,U=fe(v)&&c>=Bn?Dt.none:fe(v)?b.composition:v,L=this._offset+(n?n._offset:0);P&&(E.parent=this);let z=NaN,O=NaN,H=0,Y=0;for(let G=0;G<c;G++){let K=l[G],se=o||G,xe=a||c,Se=NaN,Je=NaN;for(let $e in u)if(Ns($e)){let $=Mo(K,$e),J=Mr($e,K,$),he=u[$e],De=ln(he);if(r&&!De&&(Ar[0]=he,Ar[1]=he,he=Ar),De){let it=he.length,Re=!cn(he[0]);it===2&&Re?(hl.to=he,cl[0]=hl,ls=cl):it>2&&Re?(ls=[],he.forEach((ht,I)=>{I?I===1?(Ar[1]=ht,ls.push(Ar)):ls.push(ht):Ar[0]=ht})):ls=he}else cl[0]=he,ls=cl;let ge=null,ze=null,xt=NaN,Le=0,We=0;for(let it=ls.length;We<it;We++){let Re=ls[We];cn(Re)?Ei=Re:(hl.to=Re,Ei=hl),ll.func=null,ru.func=null;let ht=sn(Ei.to,K,se,xe,ll),I;cn(ht)&&!fe(ht.to)?(Ei=ht,I=ht.to):I=ht;let pt=sn(Ei.from,K,se,xe),Ve=Ei.ease||y,lt=sn(Ve,K,se,xe),re=Tt(lt)||It(lt)?lt:Ve,w=!fe(re)&&!fe(re.ease),x=w?re.ease:re,F=w?re.settlingDuration:sn(Ne(Ei.duration,it>1?sn(S,K,se,xe)/it:S),K,se,xe),Z=sn(Ne(Ei.delay,We?0:C),K,se,xe),j=sn(Ne(Ei.composition,U),K,se,xe),q=zt(j)?j:Dt[j],Te=Ei.modifier||D,oe=!fe(pt),Me=!fe(I),Ce=ln(I),ie=Ce||oe&&Me,le=ze?Le+Z:Z,ye=Qe(L+le,12);!Y&&(oe||Ce)&&(Y=1);let me=ze;if(q!==Dt.none){ge||(ge=wo(K,J));let te=ge._head;for(;te&&!te._isOverridden&&te._absoluteStartTime<=ye;)if(me=te,te=te._nextRep,te&&te._absoluteStartTime>=ye)for(;te;)Eo(te),te=te._nextRep}if(ie){hn(Ce?sn(I[0],K,se,xe,ru):pt,Oe),hn(Ce?sn(I[1],K,se,xe,ll):I,et);let te=vi(K,J,$,wr);Oe.t===Ze.NUMBER&&(me?me._valueType===Ze.UNIT&&(Oe.t=Ze.UNIT,Oe.u=me._unit):(hn(te,rn),rn.t===Ze.UNIT&&(Oe.t=Ze.UNIT,Oe.u=rn.u)))}else Me?hn(I,et):ze?Zh(ze,et):hn(n&&me&&me.parent.parent===n?me._value:vi(K,J,$,wr),et),oe?hn(pt,Oe):ze?Zh(ze,Oe):hn(n&&me&&me.parent.parent===n?me._value:vi(K,J,$,wr),Oe);if(Oe.o&&(Oe.n=Si(me?me._toNumber:hn(vi(K,J,$,wr),rn).n,Oe.n,Oe.o)),et.o&&(et.n=Si(Oe.n,et.n,et.o)),Oe.t!==et.t){if(Oe.t===Ze.COMPLEX||et.t===Ze.COMPLEX){let te=Oe.t===Ze.COMPLEX?Oe:et,ee=Oe.t===Ze.COMPLEX?et:Oe;ee.t=Ze.COMPLEX,ee.s=Vt(te.s),ee.d=te.d.map(()=>ee.n)}else if(Oe.t===Ze.UNIT||et.t===Ze.UNIT){let te=Oe.t===Ze.UNIT?Oe:et,ee=Oe.t===Ze.UNIT?et:Oe;ee.t=Ze.UNIT,ee.u=te.u}else if(Oe.t===Ze.COLOR||et.t===Ze.COLOR){let te=Oe.t===Ze.COLOR?Oe:et,ee=Oe.t===Ze.COLOR?et:Oe;ee.t=Ze.COLOR,ee.s=te.s,ee.d=[0,0,0,1]}}if(Oe.u!==et.u){let te=et.u?Oe:et;te=Bs(K,te,et.u?et.u:Oe.u,!1)}if(et.d&&Oe.d&&et.d.length!==Oe.d.length){let te=Oe.d.length>et.d.length?Oe:et,ee=te===Oe?et:Oe;ee.d=te.d.map((_e,ne)=>fe(ee.d[ne])?0:ee.d[ne]),ee.s=Vt(te.s)}let ae=Qe(+F||Ge,12),qe=wr[J];$n(qe)||(wr[J]=null);let N={parent:this,id:Y_++,property:J,target:K,_value:null,_toFunc:ll.func,_fromFunc:ru.func,_ease:qi(x),_fromNumbers:Vt(Oe.d),_toNumbers:Vt(et.d),_strings:Vt(et.s),_fromNumber:Oe.n,_toNumber:et.n,_numbers:Vt(Oe.d),_number:Oe.n,_unit:et.u,_modifier:Te,_currentTime:0,_startTime:le,_delay:+Z,_updateDuration:ae,_changeDuration:ae,_absoluteStartTime:ye,_tweenType:$,_valueType:et.t,_composition:q,_isOverlapped:0,_isOverridden:0,_renderTransforms:0,_inlineValue:qe,_prevRep:null,_nextRep:null,_prevAdd:null,_nextAdd:null,_prev:null,_next:null};q!==Dt.none&&sl(N,ge),isNaN(xt)&&(xt=N._startTime),Le=Qe(le+ae,12),ze=N,H++,gn(this,N)}(isNaN(O)||xt<O)&&(O=xt),(isNaN(z)||Le>z)&&(z=Le),$===vt.TRANSFORM&&(Se=H-We,Je=H)}if(!isNaN(Se)){let $e=0;rt(this,$=>{$e>=Se&&$e<Je&&($._renderTransforms=1,$._composition===Dt.blend&&rt(Gi.animation,J=>{J.id===$.id&&(J._renderTransforms=1)})),$e++})}}c||console.warn("No target found. Make sure the element you're trying to animate is accessible before creating your animation."),O?(rt(this,G=>{G._startTime-G._delay||(G._delay-=O),G._startTime-=O}),z-=O):O=0,z||(z=Ge,this.iterationCount=0),this.targets=l,this.id=fe(d)?Lp:d,this.duration=z===Ge?Ge:Fs((z+this._loopDelay)*this.iterationCount-this._loopDelay)||Ge,this.onRender=T||b.onRender,this._ease=R,this._delay=O,this.iterationDuration=z,!this._autoplay&&Y&&this.onRender(this)}stretch(e){let t=this.duration;if(t===Hi(e))return this;let n=e/t;return rt(this,s=>{s._updateDuration=Hi(s._updateDuration*n),s._changeDuration=Hi(s._changeDuration*n),s._currentTime*=n,s._startTime*=n,s._absoluteStartTime*=n}),super.stretch(e)}refresh(){return rt(this,e=>{let t=e._toFunc,n=e._fromFunc;(t||n)&&(n?(hn(n(),Oe),Oe.u!==e._unit&&e.target[xi]&&Bs(e.target,Oe,e._unit,!0),e._fromNumbers=Vt(Oe.d),e._fromNumber=Oe.n):t&&(hn(vi(e.target,e.property,e._tweenType),rn),e._fromNumbers=Vt(rn.d),e._fromNumber=rn.n),t&&(hn(t(),et),e._toNumbers=Vt(et.d),e._strings=Vt(et.s),e._toNumber=et.o?Si(e._fromNumber,et.n,et.o):et.n))}),this.duration===Ge&&this.restart(),this}revert(){return super.revert(),Os(this)}then(e){return super.then(e)}},qt=(i,e)=>new cs(i,e,null,0,!1).init()});var Z_,ks,ou=Ee(()=>{Rt();Pt();Mi();Z_=(i,e)=>{if(Ct(e,"<")){let t=e[1]==="<",n=i._tail,s=n?n._offset+n._delay:0;return t?s:s+n.duration}},ks=(i,e)=>{let t=i.iterationDuration;if(t===Ge&&(t=0),fe(e))return t;if(zt(+e))return+e;let n=e,s=i?i.labels:null,r=!$n(s),o=Z_(i,n),a=!fe(o),l=Ka.exec(n);if(l){let c=l[0],h=n.split(c),u=r&&h[0]?s[h[0]]:t,d=a?o:r?u:t,p=+h[1];return Si(d,p,c[0])}else return a?o:r?fe(s[n])?t:s[n]:t}});function K_(i){return Fs((i.iterationDuration+i._loopDelay)*i.iterationCount-i._loopDelay)||Ge}function au(i,e,t,n,s,r){let a=zt(i.duration)&&i.duration<=Ge?t-Ge:t;e.composition&&bi(e,a,1,1,Wt.AUTO);let l=n?new cs(n,i,e,a,!1,s,r):new Rn(i,e,a);return e.composition&&l.init(!0),gn(e,l),rt(e,c=>{let u=c._offset+c._delay+c.duration;u>e.iterationDuration&&(e.iterationDuration=u)}),e.duration=K_(e),e}var Dp,dl,_n,Np=Ee(()=>{wn();Rt();Pt();Mi();Xi();To();br();Ro();ul();Co();Er();ou();Dp=0,dl=class extends Rn{constructor(e={}){super(e,null,0),++Dp,this.id=fe(e.id)?Dp:e.id,this.duration=0,this.labels={};let t=e.defaults,n=Xe.defaults;this.defaults=t?el(t,n):n,this.composition=Ne(e.composition,!0),this.onRender=e.onRender||n.onRender;let s=Ne(e.playbackEase,n.playbackEase);this._ease=s?qi(s):null,this.iterationDuration=0}add(e,t,n){let s=cn(t),r=cn(e);if(s||r){if(this._hasChildren=!0,s){let o=t;if(Tt(n)){let a=n,l=Wi(e),c=this.duration,h=this.iterationDuration,u=o.id,d=0,p=l.length;l.forEach(g=>{let _={...o};this.duration=c,this.iterationDuration=h,fe(u)||(_.id=u+"-"+d),au(_,this,ks(this,a(g,d,p,this)),g,d,p),d++})}else au(o,this,ks(this,n),e)}else au(e,this,ks(this,t));return this.composition&&this.init(!0),this}}sync(e,t){if(fe(e)||e&&fe(e.pause))return this;e.pause();let n=+(e.effect?e.effect.getTiming().duration:e.duration);return!fe(e)&&!fe(e.persist)&&(e.persist=!0),this.add(e,{currentTime:[0,n],duration:n,delay:0,ease:"linear",playbackEase:"linear"},t)}set(e,t,n){return fe(t)?this:(t.duration=Ge,t.composition=Dt.replace,this.add(e,t,n))}call(e,t){return fe(e)||e&&!Tt(e)?this:this.add({duration:0,delay:0,onComplete:()=>e(this)},t)}label(e,t){return fe(e)||e&&!It(e)?this:(this.labels[e]=ks(this,t),this)}remove(e,t){return Ao(Wi(e),this,t),this}stretch(e){let t=this.duration;if(t===Hi(e))return this;let n=e/t,s=this.labels;rt(this,r=>r.stretch(r.duration*n));for(let r in s)s[r]*=n;return super.stretch(e)}refresh(){return rt(this,e=>{e.refresh&&e.refresh()}),this}revert(){return super.revert(),rt(this,e=>e.revert,!0),Os(this)}then(e){return super.then(e)}},_n=i=>new dl(i).init()});var lu={};Ya(lu,{clamp:()=>Ot,damp:()=>sx,degToRad:()=>nx,lerp:()=>An,mapRange:()=>tx,padEnd:()=>Q_,padStart:()=>j_,radToDeg:()=>ix,round:()=>Qe,roundPad:()=>J_,snap:()=>mp,wrap:()=>ex});var J_,j_,Q_,ex,tx,nx,ix,sx,Up=Ee(()=>{Pt();Pt();J_=(i,e)=>(+i).toFixed(e),j_=(i,e,t)=>`${i}`.padStart(e,t),Q_=(i,e,t)=>`${i}`.padEnd(e,t),ex=(i,e,t)=>((i-e)%(t-e)+(t-e))%(t-e)+e,tx=(i,e,t,n,s)=>n+(i-e)/(t-e)*(s-n),nx=i=>i*Math.PI/180,ix=i=>i*180/Math.PI,sx=(i,e,t,n)=>n?n===1?e:An(i,e,1-Math.exp(-n*t*.1)):i});var cu,fl,hu,uu=Ee(()=>{Pt();cu={_head:null,_tail:null},fl=(i,e,t)=>{let n=cu._head,s;for(;n;){let r=n._next,o=n.$el===i,a=!e||n.property===e,l=!t||n.parent===t;if(o&&a&&l){s=n.animation;try{s.commitStyles()}catch{}s.cancel(),kn(cu,n);let c=n.parent;c&&(c._completed++,c.animations.length===c._completed&&(c.completed=!0,c.paused=!0,c.muteCallbacks||(c.onComplete(c),c._resolve(c))))}n=r}return s},hu=(i,e,t,n,s)=>{let r=e.animate(n,s),o=s.delay+ +s.duration*s.iterations;r.playbackRate=i._speed,i.paused&&r.pause(),i.duration<o&&(i.duration=o,i.controlAnimation=r),i.animations.push(r),fl(e,t),gn(cu,{parent:i,animation:r,$el:e,property:t,_next:null,_prev:null});let a=()=>fl(e,t,i);return r.oncancel=a,r.onremove=a,i.persist||(r.onfinish=a),r}});function Lo(i,e,t){let n=Ti(i);if(!n.length)return;let[s]=n,r=Mo(s,e),o=Mr(e,s,r),a=vi(s,o);if(fe(t))return a;if(hn(a,rn),rn.t===Ze.NUMBER||rn.t===Ze.UNIT){if(t===!1)return rn.n;{let l=Bs(s,rn,t,!1);return`${Qe(l.n,Xe.precision)}${l.u}`}}}var Do,Fp,du=Ee(()=>{wn();Rt();Pt();Xi();br();Mi();ol();uu();Ro();ul();Do=(i,e)=>{if(!fe(e))return e.duration=Ge,e.composition=Ne(e.composition,Dt.none),new cs(i,e,null,0,!0).resume()},Fp=(i,e,t)=>{let n=Wi(i);for(let s=0,r=n.length;s<r;s++)fl(n[s],t,e&&e.controlAnimation&&e);return Ao(n,e,t),n}});var pl,ml,gl=Ee(()=>{Rt();wn();Pt();Co();pl=(i=je)=>new Rn({duration:1*Xe.timeScale,onComplete:i},null,0).resume(),ml=i=>{let e;return(...t)=>{let n,s,r,o;e&&(n=e.currentIteration,s=e.iterationProgress,r=e.reversed,o=e._alternate,e.revert());let a=i(...t);return a&&!Tt(a)&&a.revert&&(e=a),fe(s)||(e.currentIteration=n,e.iterationProgress=(o&&n%2?!r:r)?1-s:s),a||je}}});var rx,_l,yl,fu,ox,No,xl,Op,ax,Bp,vl,Zn,kp=Ee(()=>{Rt();wn();Pt();Xi();Mi();ol();Co();du();gl();Io();Er();rx=()=>{let i=ct.createElement("div");ct.body.appendChild(i),i.style.height="100lvh";let e=i.offsetHeight;return ct.body.removeChild(i),e},_l=(i,e)=>i&&Tt(i)?i(e):i,yl=new Map,fu=class{constructor(e){this.element=e,this.useWin=this.element===ct.body,this.winWidth=0,this.winHeight=0,this.width=0,this.height=0,this.left=0,this.top=0,this.scale=1,this.zIndex=0,this.scrollX=0,this.scrollY=0,this.prevScrollX=0,this.prevScrollY=0,this.scrollWidth=0,this.scrollHeight=0,this.velocity=0,this.backwardX=!1,this.backwardY=!1,this.scrollTicker=new Rn({autoplay:!1,onBegin:()=>this.dataTimer.resume(),onUpdate:()=>{let t=this.backwardX||this.backwardY;rt(this,n=>n.handleScroll(),t)},onComplete:()=>this.dataTimer.pause()}).init(),this.dataTimer=new Rn({autoplay:!1,frameRate:30,onUpdate:t=>{let n=t.deltaTime,s=this.prevScrollX,r=this.prevScrollY,o=this.scrollX,a=this.scrollY,l=s-o,c=r-a;this.prevScrollX=o,this.prevScrollY=a,l&&(this.backwardX=s>o),c&&(this.backwardY=r>a),this.velocity=Qe(n>0?Math.sqrt(l*l+c*c)/n:0,5)}}).init(),this.resizeTicker=new Rn({autoplay:!1,duration:250*Xe.timeScale,onComplete:()=>{this.updateWindowBounds(),this.refreshScrollObservers(),this.handleScroll()}}).init(),this.wakeTicker=new Rn({autoplay:!1,duration:500*Xe.timeScale,onBegin:()=>{this.scrollTicker.resume()},onComplete:()=>{this.scrollTicker.pause()}}).init(),this._head=null,this._tail=null,this.updateScrollCoords(),this.updateWindowBounds(),this.updateBounds(),this.refreshScrollObservers(),this.handleScroll(),this.resizeObserver=new ResizeObserver(()=>this.resizeTicker.restart()),this.resizeObserver.observe(this.element),(this.useWin?ii:this.element).addEventListener("scroll",this,!1)}updateScrollCoords(){let e=this.useWin,t=this.element;this.scrollX=Qe(e?ii.scrollX:t.scrollLeft,0),this.scrollY=Qe(e?ii.scrollY:t.scrollTop,0)}updateWindowBounds(){this.winWidth=ii.innerWidth,this.winHeight=rx()}updateBounds(){let e=getComputedStyle(this.element),t=this.element;this.scrollWidth=t.scrollWidth+parseFloat(e.marginLeft)+parseFloat(e.marginRight),this.scrollHeight=t.scrollHeight+parseFloat(e.marginTop)+parseFloat(e.marginBottom),this.updateWindowBounds();let n,s;if(this.useWin)n=this.winWidth,s=this.winHeight;else{let r=t.getBoundingClientRect();n=t.clientWidth,s=t.clientHeight,this.top=r.top,this.left=r.left,this.scale=r.width?n/r.width:r.height?s/r.height:1}this.width=n,this.height=s}refreshScrollObservers(){rt(this,e=>{e._debug&&e.removeDebug()}),this.updateBounds(),rt(this,e=>{e.refresh(),e.onResize(e),e._debug&&e.debug()})}refresh(){this.updateWindowBounds(),this.updateBounds(),this.refreshScrollObservers(),this.handleScroll()}handleScroll(){this.updateScrollCoords(),this.wakeTicker.restart()}handleEvent(e){e.type==="scroll"&&this.handleScroll()}revert(){this.scrollTicker.cancel(),this.dataTimer.cancel(),this.resizeTicker.cancel(),this.wakeTicker.cancel(),this.resizeObserver.disconnect(),(this.useWin?ii:this.element).removeEventListener("scroll",this),yl.delete(this.element)}},ox=i=>{let e=i?Wi(i)[0]||ct.body:ct.body,t=yl.get(e);return t||(t=new fu(e),yl.set(e,t)),t},No=(i,e,t,n,s)=>{let r=e==="min",o=e==="max",a=e==="top"||e==="left"||e==="start"||r?0:e==="bottom"||e==="right"||e==="end"||o?"100%":e==="center"?"50%":e,{n:l,u:c}=hn(a,rn),h=l;return c==="%"?h=l/100*t:c&&(h=Bs(i,rn,"px",!0).n),o&&n<0&&(h+=n),r&&s>0&&(h+=s),h},xl=(i,e,t,n,s)=>{let r;if(It(e)){let o=Ka.exec(e);if(o){let a=o[0],l=a[0],c=e.split(a),h=c[0]==="min",u=c[0]==="max",d=No(i,c[0],t,n,s),p=No(i,c[1],t,n,s);if(h){let g=Si(No(i,"min",t),p,l);r=g<d?d:g}else if(u){let g=Si(No(i,"max",t),p,l);r=g>d?d:g}else r=Si(d,p,l)}else r=No(i,e,t,n,s)}else r=e;return Qe(r,0)},Op=i=>{let e,t=i.targets;for(let n=0,s=t.length;n<s;n++){let r=t[n];if(r[xi]){e=r;break}}return e},ax=0,Bp=["#FF4B4B","#FF971B","#FFC730","#F9F640","#7AFF5A","#18FF74","#17E09B","#3CFFEC","#05DBE9","#33B3F1","#638CF9","#C563FE","#FF4FCF","#F93F8A"],vl=class{constructor(e={}){En.current&&En.current.register(this);let t=Ne(e.sync,"play pause"),n=t?qi(t):null,s=t&&(t==="linear"||t===un),r=t&&!(n===un&&!s),o=t&&(zt(t)||t===!0||s),a=t&&It(t)&&!r&&!o,l=a?t.split(" ").map(h=>()=>{let u=this.linked;return u&&u[h]?u[h]():null}):null,c=a&&l.length>2;this.index=ax++,this.id=fe(e.id)?this.index:e.id,this.container=ox(e.container),this.target=null,this.linked=null,this.repeat=null,this.horizontal=null,this.enter=null,this.leave=null,this.sync=r||o||!!l,this.syncEase=r?n:null,this.syncSmooth=o?t===!0||s?1:t:null,this.onSyncEnter=l&&!c&&l[0]?l[0]:je,this.onSyncLeave=l&&!c&&l[1]?l[1]:je,this.onSyncEnterForward=l&&c&&l[0]?l[0]:je,this.onSyncLeaveForward=l&&c&&l[1]?l[1]:je,this.onSyncEnterBackward=l&&c&&l[2]?l[2]:je,this.onSyncLeaveBackward=l&&c&&l[3]?l[3]:je,this.onEnter=e.onEnter||je,this.onLeave=e.onLeave||je,this.onEnterForward=e.onEnterForward||je,this.onLeaveForward=e.onLeaveForward||je,this.onEnterBackward=e.onEnterBackward||je,this.onLeaveBackward=e.onLeaveBackward||je,this.onUpdate=e.onUpdate||je,this.onResize=e.onResize||je,this.onSyncComplete=e.onSyncComplete||je,this.reverted=!1,this.ready=!1,this.completed=!1,this.began=!1,this.isInView=!1,this.forceEnter=!1,this.hasEntered=!1,this.offset=0,this.offsetStart=0,this.offsetEnd=0,this.distance=0,this.prevProgress=0,this.thresholds=["start","end","end","start"],this.coords=[0,0,0,0],this.debugStyles=null,this.$debug=null,this._params=e,this._debug=Ne(e.debug,!1),this._next=null,this._prev=null,gn(this.container,this),pl(()=>{if(!this.reverted){if(!this.target){let h=Wi(e.target)[0];this.target=h||ct.body,this.refresh()}this._debug&&this.debug()}})}link(e){if(e&&(e.pause(),this.linked=e,!fe(e)&&!fe(e.persist)&&(e.persist=!0),!this._params.target)){let t;fe(e.targets)?rt(e,n=>{n.targets&&!t&&(t=Op(n))}):t=Op(e),this.target=t||ct.body,this.refresh()}return this}get velocity(){return this.container.velocity}get backward(){return this.horizontal?this.container.backwardX:this.container.backwardY}get scroll(){return this.horizontal?this.container.scrollX:this.container.scrollY}get progress(){let e=(this.scroll-this.offsetStart)/this.distance;return e===1/0||isNaN(e)?0:Qe(Ot(e,0,1),6)}refresh(){this.ready=!0,this.reverted=!1;let e=this._params;return this.repeat=Ne(_l(e.repeat,this),!0),this.horizontal=Ne(_l(e.axis,this),"y")==="x",this.enter=Ne(_l(e.enter,this),"end start"),this.leave=Ne(_l(e.leave,this),"start end"),this.updateBounds(),this.handleScroll(),this}removeDebug(){return this.$debug&&(this.$debug.parentNode.removeChild(this.$debug),this.$debug=null),this.debugStyles&&(this.debugStyles.revert(),this.$debug=null),this}debug(){this.removeDebug();let e=this.container,t=this.horizontal,n=e.element.querySelector(":scope > .animejs-onscroll-debug"),s=ct.createElement("div"),r=ct.createElement("div"),o=ct.createElement("div"),a=Bp[this.index%Bp.length],l=e.useWin,c=l?e.winWidth:e.width,h=l?e.winHeight:e.height,u=e.scrollWidth,d=e.scrollHeight,p=this.container.width>360?320:260,g=t?0:10,_=t?10:0,m=t?24:p/2,f=t?m:15,v=t?60:m,T=t?v:f,b=t?"repeat-x":"repeat-y",E=S=>t?"0px "+S+"px":S+"px 2px",A=S=>`linear-gradient(${t?90:0}deg, ${S} 2px, transparent 1px)`,R=(S,C,D,U,L)=>`position:${S};left:${C}px;top:${D}px;width:${U}px;height:${L}px;`;s.style.cssText=`${R("absolute",g,_,t?u:p,t?p:d)}
	...
	`}function fM(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){let l=a.mapping,c=l===or||l===Cc,h=l===Ts||l===rr;if(c||h){let u=e.get(a),d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new uo(i)),u=c?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{let p=a.image;return c&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new uo(i)),u=c?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let l=0,c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){let l=a.target;l.removeEventListener("dispose",r);let c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function pM(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&Yr("WebGLRenderer: "+n+" extension not supported."),s}}}function mM(i,e,t,n){let s={},r=new WeakMap;function o(u){let d=u.target;d.index!==null&&e.remove(d.index);for(let g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete s[d.id];let p=r.get(d);p&&(e.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,t.memory.geometries++),d}function l(u){let d=u.attributes;for(let p in d)e.update(d[p],i.ARRAY_BUFFER)}function c(u){let d=[],p=u.index,g=u.attributes.position,_=0;if(p!==null){let v=p.array;_=p.version;for(let T=0,b=v.length;T<b;T+=3){let E=v[T+0],A=v[T+1],R=v[T+2];d.push(E,A,A,R,R,E)}}else if(g!==void 0){let v=g.array;_=g.version;for(let T=0,b=v.length/3-1;T<b;T+=3){let E=T+0,A=T+1,R=T+2;d.push(E,A,A,R,R,E)}}else return;let m=new(Ad(d)?ia:na)(d,1);m.version=_;let f=r.get(u);f&&e.remove(f),r.set(u,m)}function h(u){let d=r.get(u);if(d){let p=u.index;p!==null&&d.version<p.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function gM(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,p){i.drawElements(n,p,r,d*o),t.update(p,n,1)}function c(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,d*o,g),t.update(p,n,g))}function h(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function u(d,p,g,_){if(g===0)return;let m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,_,0,g);let f=0;for(let v=0;v<g;v++)f+=p[v]*_[v];t.update(f,n,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function _M(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:Ue("WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function xM(i,e,t){let n=new WeakMap,s=new Lt;function r(o,a,l){let c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0,d=n.get(a);if(d===void 0||d.count!==u){let y=function(){R.dispose(),n.delete(a),a.removeEventListener("dispose",y)};d!==void 0&&d.texture.dispose();let p=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],f=a.morphAttributes.normal||[],v=a.morphAttributes.color||[],T=0;p===!0&&(T=1),g===!0&&(T=2),_===!0&&(T=3);let b=a.attributes.position.count*T,E=1;b>e.maxTextureSize&&(E=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);let A=new Float32Array(b*E*4*u),R=new ea(A,b,E,u);R.type=an,R.needsUpdate=!0;let P=T*4;for(let S=0;S<u;S++){let C=m[S],D=f[S],U=v[S],L=b*E*4*S;for(let z=0;z<C.count;z++){let O=z*P;p===!0&&(s.fromBufferAttribute(C,z),A[L+O+0]=s.x,A[L+O+1]=s.y,A[L+O+2]=s.z,A[L+O+3]=0),g===!0&&(s.fromBufferAttribute(D,z),A[L+O+4]=s.x,A[L+O+5]=s.y,A[L+O+6]=s.z,A[L+O+7]=0),_===!0&&(s.fromBufferAttribute(U,z),A[L+O+8]=s.x,A[L+O+9]=s.y,A[L+O+10]=s.z,A[L+O+11]=U.itemSize===4?s.w:1)}}d={count:u,texture:R,size:new Be(b,E)},n.set(a,d),a.addEventListener("dispose",y)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let p=0;for(let _=0;_<c.length;_++)p+=c[_];let g=a.morphTargetsRelative?1:1-p;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function yM(i,e,t,n){let s=new WeakMap;function r(l){let c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){let d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function o(){s=new WeakMap}function a(l){let c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}function SM(i,e,t,n,s){let r=new Gn(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),o=new Gn(e,t,{type:Mn,depthBuffer:!1,stencilBuffer:!1}),a=new vn;a.setAttribute("position",new yn([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new yn([0,2,0,0,2,0],2));let l=new hc({uniforms:{tDiffuse:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new on(a,l),h=new Di(-1,1,1,-1,0,1),u=null,d=null,p=!1,g,_=null,m=[],f=!1;this.setSize=function(v,T){r.setSize(v,T),o.setSize(v,T);for(let b=0;b<m.length;b++){let E=m[b];E.setSize&&E.setSize(v,T)}},this.setEffects=function(v){m=v,f=m.length>0&&m[0].isRenderPass===!0;let T=r.width,b=r.height;for(let E=0;E<m.length;E++){let A=m[E];A.setSize&&A.setSize(T,b)}},this.begin=function(v,T){if(p||v.toneMapping===mi&&m.length===0)return!1;if(_=T,T!==null){let b=T.width,E=T.height;(r.width!==b||r.height!==E)&&this.setSize(b,E)}return f===!1&&v.setRenderTarget(r),g=v.toneMapping,v.toneMapping=mi,!0},this.hasRenderPass=function(){return f},this.end=function(v,T){v.toneMapping=g,p=!0;let b=r,E=o;for(let A=0;A<m.length;A++){let R=m[A];if(R.enabled!==!1&&(R.render(v,E,b,T),R.needsSwap!==!1)){let P=b;b=E,E=P}}if(u!==v.outputColorSpace||d!==v.toneMapping){u=v.outputColorSpace,d=v.toneMapping,l.defines={},ot.getTransfer(u)===ft&&(l.defines.SRGB_TRANSFER="");let A=vM[d];A&&(l.defines[A]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=b.texture,v.setRenderTarget(_),v.render(c,h),_=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),l.dispose()}}function fo(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=Vg[s];if(r===void 0&&(r=new Float32Array(s),Vg[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function $t(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Zt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Th(i,e){let t=Hg[e];t===void 0&&(t=new Int32Array(e),Hg[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function MM(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function bM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if($t(t,e))return;i.uniform2fv(this.addr,e),Zt(t,e)}}function TM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if($t(t,e))return;i.uniform3fv(this.addr,e),Zt(t,e)}}function EM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if($t(t,e))return;i.uniform4fv(this.addr,e),Zt(t,e)}}function wM(i,e){let t=this.cache,n=e.elements;if(n===void 0){if($t(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Zt(t,e)}else{if($t(t,n))return;Xg.set(n),i.uniformMatrix2fv(this.addr,!1,Xg),Zt(t,n)}}function AM(i,e){let t=this.cache,n=e.elements;if(n===void 0){if($t(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Zt(t,e)}else{if($t(t,n))return;Wg.set(n),i.uniformMatrix3fv(this.addr,!1,Wg),Zt(t,n)}}function RM(i,e){let t=this.cache,n=e.elements;if(n===void 0){if($t(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Zt(t,e)}else{if($t(t,n))return;Gg.set(n),i.uniformMatrix4fv(this.addr,!1,Gg),Zt(t,n)}}function CM(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function IM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if($t(t,e))return;i.uniform2iv(this.addr,e),Zt(t,e)}}function PM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if($t(t,e))return;i.uniform3iv(this.addr,e),Zt(t,e)}}function LM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if($t(t,e))return;i.uniform4iv(this.addr,e),Zt(t,e)}}function DM(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function NM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if($t(t,e))return;i.uniform2uiv(this.addr,e),Zt(t,e)}}function UM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if($t(t,e))return;i.uniform3uiv(this.addr,e),Zt(t,e)}}function FM(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if($t(t,e))return;i.uniform4uiv(this.addr,e),Zt(t,e)}}function OM(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(zd.compareFunction=t.isReversedDepthBuffer()?yh:xh,r=zd):r=r0,t.setTexture2D(e||r,s)}function BM(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||a0,s)}function kM(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||l0,s)}function zM(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||o0,s)}function VM(i){switch(i){case 5126:return MM;case 35664:return bM;case 35665:return TM;case 35666:return EM;case 35674:return wM;case 35675:return AM;case 35676:return RM;case 5124:case 35670:return CM;case 35667:case 35671:return IM;case 35668:case 35672:return PM;case 35669:case 35673:return LM;case 5125:return DM;case 36294:return NM;case 36295:return UM;case 36296:return FM;case 35678:case 36198:case 36298:case 36306:case 35682:return OM;case 35679:case 36299:case 36307:return BM;case 35680:case 36300:case 36308:case 36293:return kM;case 36289:case 36303:case 36311:case 36292:return zM}}function HM(i,e){i.uniform1fv(this.addr,e)}function GM(i,e){let t=fo(e,this.size,2);i.uniform2fv(this.addr,t)}function WM(i,e){let t=fo(e,this.size,3);i.uniform3fv(this.addr,t)}function XM(i,e){let t=fo(e,this.size,4);i.uniform4fv(this.addr,t)}function qM(i,e){let t=fo(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function YM(i,e){let t=fo(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function $M(i,e){let t=fo(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function ZM(i,e){i.uniform1iv(this.addr,e)}function KM(i,e){i.uniform2iv(this.addr,e)}function JM(i,e){i.uniform3iv(this.addr,e)}function jM(i,e){i.uniform4iv(this.addr,e)}function QM(i,e){i.uniform1uiv(this.addr,e)}function eb(i,e){i.uniform2uiv(this.addr,e)}function tb(i,e){i.uniform3uiv(this.addr,e)}function nb(i,e){i.uniform4uiv(this.addr,e)}function ib(i,e,t){let n=this.cache,s=e.length,r=Th(t,s);$t(n,r)||(i.uniform1iv(this.addr,r),Zt(n,r));let o;this.type===i.SAMPLER_2D_SHADOW?o=zd:o=r0;for(let a=0;a!==s;++a)t.setTexture2D(e[a]||o,r[a])}function sb(i,e,t){let n=this.cache,s=e.length,r=Th(t,s);$t(n,r)||(i.uniform1iv(this.addr,r),Zt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||a0,r[o])}function rb(i,e,t){let n=this.cache,s=e.length,r=Th(t,s);$t(n,r)||(i.uniform1iv(this.addr,r),Zt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||l0,r[o])}function ob(i,e,t){let n=this.cache,s=e.length,r=Th(t,s);$t(n,r)||(i.uniform1iv(this.addr,r),Zt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||o0,r[o])}function ab(i){switch(i){case 5126:return HM;case 35664:return GM;case 35665:return WM;case 35666:return XM;case 35674:return qM;case 35675:return YM;case 35676:return $M;case 5124:case 35670:return ZM;case 35667:case 35671:return KM;case 35668:case 35672:return JM;case 35669:case 35673:return jM;case 5125:return QM;case 36294:return eb;case 36295:return tb;case 36296:return nb;case 35678:case 36198:case 36298:case 36306:case 35682:return ib;case 35679:case 36299:case 36307:return sb;case 35680:case 36300:case 36308:case 36293:return rb;case 36289:case 36303:case 36311:case 36292:return ob}}function qg(i,e){i.seq.push(e),i.map[e.id]=e}function lb(i,e,t){let n=i.name,s=n.length;for(Bd.lastIndex=0;;){let r=Bd.exec(n),o=Bd.lastIndex,a=r[1],l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){qg(t,c===void 0?new Vd(a,i,e):new Hd(a,i,e));break}else{let u=t.map[a];u===void 0&&(u=new Gd(a),qg(t,u)),t=u}}}function Yg(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}function ub(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){let a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function db(i){ot._getMatrix($g,ot.workingColorSpace,i);let e=`mat3( ${$g.elements.map(t=>t.toFixed(4))} )`;switch(ot.getTransfer(i)){case Jo:return[e,"LinearTransferOETF"];case ft:return[e,"sRGBTransferOETF"];default:return we("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Zg(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return t.toUpperCase()+`
...
#define LOW_PRECISION`),e}function wb(i){return Eb[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}function Rb(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Ab[i.envMapMode]||"ENVMAP_TYPE_CUBE"}function Ib(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Cb[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}function Lb(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Pb[i.combine]||"ENVMAP_BLENDING_NONE"}function Db(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Nb(i,e,t,n){let s=i.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,l=wb(t),c=Rb(t),h=Ib(t),u=Lb(t),d=Db(t),p=_b(t),g=xb(r),_=s.createProgram(),m,f,v=t.glslVersion?"#version "+t.glslVersion+`
...
}`,$b=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],Zb=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],i0=new Ke,Ba=new B,kd=new B;Jb={[Mc]:bc,[Tc]:Ac,[Ec]:Rc,[$s]:wc,[bc]:Mc,[Ac]:Tc,[Rc]:Ec,[wc]:$s};tT=`
void main() {
